#Data import
rm(list=ls(all=TRUE))
COHA_case <- read.delim("[pathname]/COHA_case.txt",header=T)
COHA_comp <- read.delim("[pathname]/COHA_comp.txt",header=T)
COCA_case <- read.delim("[pathname]/COCA_case.txt",header=T)
COCA_comp <- read.delim("[pathname]/COCA_comp.txt",header=T)
COCA_per <- read.delim("[pathname]/COCA_per.txt",header=T)
